...
import turnOffLights from "./modules/turnOffLight.js";

console.log("I am testing out the co(nsole");

let firstName= "Varlene";//declaring a variable
...
function testing(){
  const myName="Varlene McFarlane";
  console.log(myName);
}
...
console.log ("The value of pi:"+ p1);
...
// check the ype of the value, and also check if they have the same values
...
/*
 ...
 : the statement you want to run when the conditition is false";
 */
